...
function LeftColPost({ name, surname, profilePicture, biography, averageRating, location, profileId }) {
  return (
    <Col xs={12} md={4} className='d-flex flex-column flex-md-row order-1 order-md-0'>
      <Card className='left-col-details mx-auto ms-md-5 mt-4 border-0 position-sticky' style={{ top: '95px' }}>
              ...
              <div className='text-center'>
                <div className='d-flex justify-content-center align-items-center gap-1s mt-1'>
                  <span className='position-relative'>
                    <MapPin size={'15px'} className='position-absolute' style={{ right: '45px', top: '4px' }} />
                    {location}
                  </span>
                </div>
